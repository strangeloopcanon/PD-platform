...
def func():
    ...
    result = Broker.Tickers.CALCULATE(ticker_symbol=symbol, ticker_name=name, total_trading_volume=SUM(historical_prices.volume)).TOP_K(5, by=total_trading_volume.DESC())
    return result
